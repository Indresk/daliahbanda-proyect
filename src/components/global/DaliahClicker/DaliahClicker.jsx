...
function DaliahClicker(){
  ...
  return(
      <div className={`fixed z-10 top-[0px] right-[0px] flex items-center font-doto h-full text-white transition-translate duration-300 ease-in-out${cookieSideBar?``:` translate-x-[85vw] lg:translate-x-[30vw]`}`}>
