        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <section>
              ...
              <picture>
                <img className="black-icon" src="https://assets.daliahbanda.com/brand/logos/full/logo-daliah-vector-black-v1.webp" alt="Daliah Banda tocando en vivo en escenario de rock alternativo en Bogotá" />
              </picture>
            </section>
            ...
            <section aria-labelledby="live-card" className="live-card">
              <article>
                ...
                <figure>
                  <img className="black-icon" src="https://assets.daliahbanda.com/brand/logos/full/logo-daliah-vector-black-v1.webp" alt="Daliah Banda transmitiendo ensayo en vivo de metalcore desde Bogotá" loading="lazy"/>
                </figure>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <section>
              ...
              <picture>
                <img className="black-icon" src="https://assets.daliahbanda.com/brand/logos/full/logo-daliah-vector-black-v1.webp" alt="Ilustración oscura y emocional que representa el estilo metalcore y emo punk de Daliah" />
              </picture>
            </section>
            <section>
              ...
              <picture>
                <img className="black-icon" src="https://assets.daliahbanda.com/brand/logos/full/logo-daliah-vector-black-v1.webp" alt="Integrantes de Daliah Banda con instrumentos, banda de metalcore colombiana" />
              </picture>
            </section>
          </div>
          ...
          <section className="">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              <article>
                ...
                <picture>
                  <img className="black-icon" src="https://assets.daliahbanda.com/brand/logos/full/logo-daliah-vector-black-v1.webp" alt="Portada del sencillo El amor se acabó de Daliah Banda" />
                </picture>
              </article>
              <article>
                ...
                <picture>
                  <img className="black-icon" src="https://assets.daliahbanda.com/brand/logos/full/logo-daliah-vector-black-v1.webp" alt="Portada ilustrada del sencillo Intento sobrevivir de Daliah Banda" />
                </picture>
              </article>
              <article>
                ...
                <picture>
                  <img className="black-icon" src="https://assets.daliahbanda.com/brand/logos/full/logo-daliah-vector-black-v1.webp" alt="Portada del sencillo Si podré de Daliah Banda, mensaje de autoafirmación" />
                </picture>
              </article>
              <article>
                ...
                <picture>
                  <img className="black-icon" src="https://assets.daliahbanda.com/brand/logos/full/logo-daliah-vector-black-v1.webp" alt="Imagen conceptual de protesta y rebeldía asociada al próximo sencillo Rebelión de Daliah" />
                </picture>
              </article>
              <article>
                <h3>Album: Daliah</h3>
                ...
                <picture>
                  <img className="black-icon" src="https://assets.daliahbanda.com/brand/logos/full/logo-daliah-vector-black-v1.webp" alt="Imagen conceptual del album Daliah de Daliah" />
                </picture>
              </article>
            </div>
          </section>
            ...
            <div className="">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <section>
                  ...
                  <picture>
                    <img className="black-icon" src="https://assets.daliahbanda.com/brand/logos/full/logo-daliah-vector-black-v1.webp" alt="Daliah Banda en concierto durante evento cultural universitario en Bogotá" />
                  </picture>
                </section>
                <section>
                  ...
                  <picture className="inline-block w-[300px]">
                    <img className="black-icon" src="https://assets.daliahbanda.com/brand/logos/icon/logo-d-daliah-vector-v1.svg" alt="Logos de Instagram y Facebook de Daliah Banda" />
                  </picture>
                </section>
              </div>
            </div>
